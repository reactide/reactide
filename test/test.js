...
describe('React Components', () => {
  ...
  describe('Directory', () => {
    ...
    it('should render', () => {
      const wrapper = shallow(<Directory directory={{ subdirectories: [], files: [] }} clickHandler={() => { }} openCreateMenu={() => { }} selectedItem={{ id: 1 }} createMenuInfo={{ id: 1 }} />);
      expect(wrapper.exists()).toEqual(true);
    });

    it('should render the right amount of subdirectories', () => {
      const wrapper = shallow(<Directory directory={{ subdirectories: [{ id: 1 }, { id: 2 }], files: [], opened: true }} clickHandler={() => { }} openCreateMenu={() => { }} selectedItem={{ id: 1 }} createMenuInfo={{ id: 1 }} />);
      expect(wrapper.find(Directory).length).toEqual(2);
    });

    it('should render the right amount of files', () => {
      const wrapper = shallow(<Directory directory={{ subdirectories: [], files: [{ id: 1 }, { id: 2 }], opened: true }} clickHandler={() => { }} openCreateMenu={() => { }} selectedItem={{ id: 1 }} createMenuInfo={{ id: 1 }} />);
      expect(wrapper.find(File).length).toEqual(2);
    });

    it('should render the right amount of both subdirectories and files', () => {
      const wrapper = shallow(<Directory directory={{ subdirectories: [{ id: 1 }, { id: 2 }], files: [{ id: 1 }, { id: 2 }], opened: true }} clickHandler={() => { }} openCreateMenu={() => { }} selectedItem={{ id: 1 }} createMenuInfo={{ id: 1 }} />);
      expect(wrapper.find(File).length).toEqual(2);
      expect(wrapper.find(Directory).length).toEqual(2);
    });

    it('shouldn\'t render any subdirectories or files if directory.opened = false', () => {
      const wrapper = shallow(<Directory directory={{ subdirectories: [{ id: 1 }, { id: 2 }], files: [{ id: 1 }, { id: 2 }], opened: false }} clickHandler={() => { }} openCreateMenu={() => { }} selectedItem={{ id: 1 }} createMenuInfo={{ id: 1 }} />);
    ...
    it('should invoke clickHandler on click', () => {
      const spy = sinon.spy();
      const wrapper = shallow(<Directory directory={{ subdirectories: [], files: [] }} clickHandler={spy} openCreateMenu={() => { }} selectedItem={{ id: 1 }} createMenuInfo={{ id: 1 }} />);
    ...
    it('should invoke clickHandler with the right arguments', () => {
      const spy = sinon.spy();
      const wrapper = shallow(<Directory directory={{ subdirectories: [], files: [], path: 'light', type: 'my' }} clickHandler={spy} openCreateMenu={() => { }} selectedItem={{ id: 1 }} createMenuInfo={{ id: 1 }} id={1} />);
      wrapper.find('.list-item').simulate('click');
  ...
  describe('TabContainer', () => {
    ...
    it('should render', () => {
      const wrapper = shallow(<TabContainer appState={{ openTabs: [{ name: 'Jonny Greenwood', id: 1 }] }} />);
      expect(wrapper.exists()).toEqual(true);
    });

    it('should render the right amount of tabs', () => {
      const wrapper = shallow(<TabContainer appState={{ openTabs: [{ name: 'Jonny Greenwood', id: 1 }, { name: 'Thom Yorke', id: 2 }] }} setActiveTab={() => { }} />);
